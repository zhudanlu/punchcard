...
public class SuccessActivity extends AppCompatActivity implements AbsListView.OnScrollListener,
    ...
    public void RefreshNotesList() {
        ...
        simp_adapter = new SimpleAdapter(this, getData(), R.layout.activity_x, new String[]{"tv_content", "tv_date"}, new int[]{
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        while (c.moveToNext()) {
            ...
            myIntent.setClass(SuccessActivity.this, NoteEdit.class);
